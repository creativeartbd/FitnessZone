<?php
			...
			<div class="entry-video-thumb"><?php
                ...
                <div class="entry-meta vertically-centered"><?php
                    ...
                    <div class="entry-info">
                        <div class="author <?php echo esc_attr( $show_author_meta );?>"><i class="zmdi zmdi-account-box zmdi-hc-fw"> </i> <a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'fitnesszone'); echo get_the_author();?>"><?php echo get_the_author();?></a></div>
                ...
                echo '<div class="password-protect"><i class="fa fa-lock"> </i>'.esc_html__('Enter your password to view comments.', 'fitnesszone')."</div>";
						...
						<?php if( shortcode_exists( 'dt_sc_post_view_count' ) && class_exists( 'DTCorePlugin' ) ): ?>
                            <div class="views"><i class="zmdi zmdi-eye zmdi-hc-fw"> </i> <?php echo do_shortcode('[dt_sc_post_view_count post_id="'.$post->ID.'" /]');?> <?php esc_html_e('Views', 'fitnesszone');?> </div>
                        <?php endif;?>
                        ...
                        <?php if( shortcode_exists( 'dt_sc_post_like_count' ) && class_exists( 'DTCorePlugin' ) ): ?>
                            <div class="likes dt_like_btn">
                                ...
                                <a href="#" data-postid="<?php the_ID(); ?>" data-action="like">
                                    ...
                                    <span><?php esc_html_e('Likes', 'fitnesszone');?></span>
                                </a>
                            </div>
                        <?php endif;?>
                    </div>
        ...
        <div class="entry-meta vertically-centered"><?php
            ...
            <div class="entry-info">
                ...
                <div class="comments <?php echo esc_attr($show_comment_meta);?>"><?php
				  comments_popup_link('<i class="fa fa-comments"> </i> 0 '.esc_html__('comments', 'fitnesszone'), '<i class="fa fa-comments"> </i> 1 '.esc_html__('comment', 'fitnesszone'), '<i class="fa fa-comments"> </i> % '.esc_html__('comments', 'fitnesszone'), '', '<i class="fa fa-comments"> </i>'.esc_html__('comments off', 'fitnesszone'));?></div>
    ...
    <div class="entry-details">
      ...
      <div class="entry-meta-data">
      	 <?php the_tags("<p class='tags {$show_tag_meta}'><span>".esc_html__('Tag List', 'fitnesszone')."</span> ",' ',"</p>"); ?>
      </div><!-- Category & Tag -->
