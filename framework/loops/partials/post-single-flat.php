<?php
    ...
    <div class="author <?php echo esc_attr( $show_author_meta );?>"><span><?php echo esc_html__('Posted by: ', 'fitnesszone'); ?><a href="<?php echo get_author_posts_url(get_the_author_meta('ID'));?>" title="<?php esc_attr_e('View all posts by ', 'fitnesszone'); echo get_the_author();?>"><?php echo get_the_author();?></a></span></div>
    ...
    <div class="entry-details">
        ...
        <div class="entry-meta">
		    <?php the_tags("<div class='tags {$show_tag_meta}'>".esc_html__('Tags : ', 'fitnesszone') ,', ','</div>'); ?>

            <div class="comments <?php echo esc_attr($show_comment_meta);?>">
            	<i class="fa fa-commentss-o"> </i>
				<?php comments_popup_link('0', '1', '%', '', esc_html('Off', 'fitnesszone')); ?>
            </div>
