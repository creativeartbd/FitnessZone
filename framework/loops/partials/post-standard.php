	  ...
	  <div class="entry-meta"><?php
		  ...
		  <div class="entry-info">
			  ...
			  <div class="comments <?php echo esc_attr($show_comment_meta);?>"><?php  if( ! post_password_required() ) {
                comments_popup_link('<span class="fa fa-comments"> </span> 0','<span class="fa fa-comments"> </span> 1',
          '<span class="fa fa-comments"> </span> % ',$show_comment_meta ,'<span class="fa fa-comments"> </span> 0');
            } else {
