        ...
        <div class="center-content-wrapper">
                ...
                <?php
                        ...
                        if( cs_get_option( 'enable-404message' ) && !empty($pageid) ):
                            ...
                            echo fitnesszone_wp_kses( $content );
                        elseif( cs_get_option( 'enable-404message' ) ):
                            echo '<div class="error-box square"><div class="error-box-inner"><h2>404 !</h2><h3>'.esc_html__('Oops!', 'fitnesszone').'</h3><h4>'.esc_html__('The page you are looking for is Not Found!', 'fitnesszone').'</h4>';
                            echo '<a class="dt-sc-button medium filled" target="_blank" href="'.esc_url(home_url('/')).'">'.esc_html__('Back To Home','fitnesszone').'</a></div></div>';
                        endif; ?>
            </div>
        </div>
    </div>    
