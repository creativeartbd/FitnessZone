...
if( is_single()):
	if( is_active_sidebar('tt-event-detail-layout-sidebar-right') ):
		dynamic_sidebar('tt-event-detail-layout-sidebar-right');
	endif;

	$enable = cs_get_option( 'show-standard-right-sidebar-for-tt-event-detail' );
	if( !empty( $enable )):
		if( is_active_sidebar('standard-sidebar-right') ):
			dynamic_sidebar('standard-sidebar-right');
		endif;
